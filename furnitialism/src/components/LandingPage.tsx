...
const LandingPage = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-stone-900 dark:text-white overflow-x-hidden overflow-y-auto h-full">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 glass-card border-b border-stone-200/50">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-stone-900 dark:text-white text-xl font-bold tracking-tight">3D Furniture Shop</h2>
                    </div>
                    <nav className="hidden md:flex items-center gap-8">
                        <a className="text-stone-600 hover:text-stone-900 dark:text-stone-300 dark:hover:text-white text-sm font-medium transition-colors"
                            href="#collections" onClick={handleNavigation}>Collections</a>
                        <a className="text-stone-600 hover:text-stone-900 dark:text-stone-300 dark:hover:text-white text-sm font-medium transition-colors"
                            href="#technology" onClick={handleNavigation}>Technology</a>
                        <a className="text-stone-600 hover:text-stone-900 dark:text-stone-300 dark:hover:text-white text-sm font-medium transition-colors"
                            href="#about" onClick={handleNavigation}>About</a>
                    </nav>
                    <div className="flex items-center gap-4">
                        <a className="hidden sm:block text-stone-900 dark:text-white text-sm font-medium hover:opacity-70 transition-opacity"
                            href="#signin" onClick={handleCTA}>Sign In</a>
                        <button
                            onClick={handleCTA}
            ...
            <section className="relative min-h-[90vh] w-full flex items-center justify-center pt-20 px-4 md:px-6">
                ...
                <div className="max-w-7xl w-full mx-auto flex flex-col items-center justify-center gap-12 text-center py-20">
                    <div className="flex flex-col gap-6 max-w-4xl mx-auto z-10">
                        ...
                        <p className="text-stone-600 dark:text-stone-300 text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed">
                    ...
                    <div className="w-full max-w-5xl glass-card p-2 md:p-3 rounded-[2rem] shadow-2xl relative group overflow-hidden">
                        <div className="relative w-full aspect-video rounded-[1.5rem] overflow-hidden bg-stone-200 dark:bg-stone-800">
            ...
            <section className="py-24 md:py-32 px-4 md:px-6 relative overflow-hidden bg-stone-50 dark:bg-stone-900/10">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col items-center gap-4 text-center mb-16">
                        <span className="px-4 py-1.5 rounded-full bg-stone-200 dark:bg-stone-800 text-stone-600 dark:text-stone-300 text-xs font-bold uppercase tracking-widest text-primary">Virtual Showrooms</span>
                        <h2 className="text-4xl md:text-5xl font-black text-stone-900 dark:text-white leading-tight">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Room 1 */}
                        <div className="group relative rounded-[2rem] overflow-hidden aspect-[4/5] bg-stone-200 dark:bg-stone-800 cursor-pointer" onClick={handleCTA}>
                        ...
                        {/* Room 2 */}
                        <div className="group relative rounded-[2rem] overflow-hidden aspect-[4/5] bg-stone-200 dark:bg-stone-800 cursor-pointer md:-translate-y-8" onClick={handleCTA}>
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent z-10 transition-opacity duration-300"></div>
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                    ...
                    <div className="mt-16 flex justify-center">
                        <button onClick={handleCTA} className="group flex items-center gap-2 text-primary font-bold hover:text-stone-900 dark:hover:text-white transition-colors">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-stone-600 dark:text-stone-400 text-sm">See how natural light interacts
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-stone-600 dark:text-stone-400 text-sm">Zoom in up to 400% without losing
                                            visual fidelity.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex-1 w-full order-1 md:order-2">
                            <div className="glass-card p-2 rounded-[2rem] gold-glow transform md:rotate-2 hover:rotate-0 transition-transform duration-500">
                                <div className="relative aspect-[4/3] rounded-[1.5rem] overflow-hidden bg-stone-800">
                                    ...
                                    <div className="absolute top-4 right-4 flex flex-col gap-2">
                                        <button className="size-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white hover:bg-white/30 transition">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
                        ...
                        <div className="lg:flex-1 w-full max-w-4xl">
                            <div className="glass-card p-2 rounded-[2rem] cyan-glow transform md:-rotate-2 hover:rotate-0 transition-transform duration-500">
                                <div className="relative aspect-[4/3] rounded-[1.5rem] overflow-hidden bg-stone-900">
                                    ...
                                    {/* Tech Overlay */}
                                    <div className="absolute inset-0 border-2 border-arctic-cyan/30 rounded-[1.5rem] m-2 pointer-events-none"></div>

                                    <div className="absolute top-6 left-6 bg-black/60 backdrop-blur-md border border-arctic-cyan/30 px-3 py-1.5 rounded-lg">
                        ...
                        <div className="flex-1 flex flex-col gap-8">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 rounded-2xl bg-stone-50 border border-stone-100 dark:bg-stone-800 dark:border-stone-700">
                                    <p className="text-3xl font-black text-stone-900 dark:text-white mb-1">2s</p>
                                    <p className="text-sm text-stone-500">Render Time</p>
                                </div>
                                <div className="p-4 rounded-2xl bg-stone-50 border border-stone-100 dark:bg-stone-800 dark:border-stone-700">
                                    <p className="text-3xl font-black text-stone-900 dark:text-white mb-1">4k</p>
            ...
            <section className="py-24 md:py-32 px-4 md:px-6">
                <div className="max-w-5xl mx-auto flex flex-col gap-16 text-center">
                    <div className="flex flex-col gap-4 items-center">
                        <span className="px-4 py-1.5 rounded-full bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-300 text-xs font-bold uppercase tracking-widest">Augmented Reality</span>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
                        ...
                        <div className="flex-1 w-full">
                            <div className="bg-white/45 backdrop-blur-2xl border border-white/40 shadow-2xl p-2 rounded-[2rem] transition-all duration-500 video-glow-hover">
                                <div className="relative aspect-video rounded-[1.5rem] overflow-hidden bg-stone-200 dark:bg-stone-800 flex items-center justify-center">
                                    {/* VIDEO: Seamless Conversion */}
                                    <video className="absolute inset-0 w-full h-full object-cover" autoPlay loop muted playsInline>
                                        <source src="/video/cart-payment-1.mp4" type="video/mp4" />
                                    </video>
                                    <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-md px-3 py-1.5 rounded-lg border border-stone-200 shadow-sm flex items-center gap-2">
            ...
            <section className="py-24 md:py-32 bg-white dark:bg-stone-900 border-y border-stone-100 dark:border-stone-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-stone-900 dark:text-white">From Scan to <span className="text-glow-primary">Sanctuary</span></h2>
                        <p className="text-stone-600 dark:text-stone-400 mt-4 max-w-2xl mx-auto">A streamlined process designed for
                            efficiency and elegance.</p>
                    </div>
                    <div className="relative">
                        {/* Connecting Line (Desktop) */}
                        <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-stone-100 dark:bg-stone-800 -translate-y-1/2 z-0"></div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                            ...
                            <div className="flex flex-col items-center text-center group">
                                <div className="w-16 h-16 rounded-2xl bg-white dark:bg-stone-800 border-2 border-primary shadow-lg shadow-primary/10 flex items-center justify-center mb-6 transition-transform group-hover:scale-110 duration-300">
                                    <span className="material-symbols-outlined text-primary text-3xl">center_focus_strong</span>
                                </div>
                                <h3 className="text-lg font-bold text-stone-900 dark:text-white mb-2">Scan Room</h3>
                                <p className="text-sm text-stone-600 dark:text-stone-400 px-4">Use your phone to capture a 360° scan
                                    of your space.</p>
                            </div>
                            {/* Step 2 */}
                            <div className="flex flex-col items-center text-center group">
                                <div className="w-16 h-16 rounded-2xl bg-white dark:bg-stone-800 border-2 border-primary shadow-lg shadow-primary/10 flex items-center justify-center mb-6 transition-transform group-hover:scale-110 duration-300 delay-75">
                                    <span className="material-symbols-outlined text-primary text-3xl">auto_fix_high</span>
                                </div>
                                <h3 className="text-lg font-bold text-stone-900 dark:text-white mb-2">AI Analysis</h3>
                                <p className="text-sm text-stone-600 dark:text-stone-400 px-4">Our engine identifies dimensions,
                                    lighting, and style.</p>
                            </div>
                            {/* Step 3 */}
                            <div className="flex flex-col items-center text-center group">
                                <div className="w-16 h-16 rounded-2xl bg-white dark:bg-stone-800 border-2 border-primary shadow-lg shadow-primary/10 flex items-center justify-center mb-6 transition-transform group-hover:scale-110 duration-300 delay-150">
                                    <span className="material-symbols-outlined text-primary text-3xl">view_in_ar</span>
                                </div>
                                <h3 className="text-lg font-bold text-stone-900 dark:text-white mb-2">Custom 3D Model</h3>
                                <p className="text-sm text-stone-600 dark:text-stone-400 px-4">Generate and tweak your new interior
                                    in real-time.</p>
                            </div>
                            {/* Step 4 */}
                            <div className="flex flex-col items-center text-center group">
                                <div className="w-16 h-16 rounded-2xl bg-stone-900 dark:bg-white text-white dark:text-stone-900 shadow-xl flex items-center justify-center mb-6 transition-transform group-hover:scale-110 duration-300 delay-200">
                                    <span className="material-symbols-outlined text-primary text-3xl">shopping_bag</span>
                                </div>
                                <h3 className="text-lg font-bold text-stone-900 dark:text-white mb-2">One-Click Purchase</h3>
                                <p className="text-sm text-stone-600 dark:text-stone-400 px-4">Buy all generated furniture items
                                    directly.</p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-24 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row gap-16 items-start">
                    ...
                    <div className="flex-1 md:sticky md:top-32">
                        <h2 className="text-3xl md:text-5xl font-bold text-stone-900 dark:text-white mb-6">Product <span className="text-glow-primary">Roadmap</span></h2>
                        <p className="text-stone-600 dark:text-stone-400 mb-8 text-lg">We are building the future of commerce. See
                            where we are headed.</p>
                        <div className="p-8 rounded-3xl glass-card border border-stone-200 dark:border-stone-800 shadow-sm hover-pulse">
                            <div className="flex justify-between items-end mb-6">
                                <div>
                                    <p className="text-sm font-bold text-primary uppercase tracking-wider mb-2">Current Status</p>
                                    <h4 className="text-2xl font-bold text-stone-900 dark:text-white">Phase 2: Acceleration</h4>
                                </div>
                    ...
                    <div className="flex-1 w-full space-y-10 relative">
                        ...
                        <div className="relative flex gap-8">
                            ...
                            <div className="flex-1 pt-1">
                                <h4 className="text-xl font-bold text-stone-900 dark:text-white line-through opacity-50">Foundation
                                    & AI Core</h4>
                                <p className="text-stone-500 dark:text-stone-500 mt-2">Initial release of the 3D rendering engine
                                    and basic furniture database.</p>
                            </div>
                        </div>
                        {/* Item 2: Active */}
                        <div className="relative flex gap-8">
                            <div className="w-12 h-12 flex-shrink-0 rounded-full bg-primary border-4 border-background-light dark:border-background-dark shadow-lg shadow-primary/30 z-10 flex items-center justify-center">
                            ...
                            <div className="flex-1 pt-1 glass-card p-6 rounded-2xl border-l-4 border-l-primary hover-pulse transition-all">
                                <div className="flex justify-between items-center mb-3">
                                    <h4 className="text-xl font-bold text-stone-900 dark:text-white">Smart Recommendation Engine</h4>
                                ...
                                <p className="text-stone-600 dark:text-stone-400 leading-relaxed">Training models on 50k+ designer
                                    portfolios to suggest personalized layouts based on space and lighting.</p>
                            </div>
                        </div>
                        {/* Item 3: Future */}
                        <div className="relative flex gap-8">
                            <div className="w-12 h-12 flex-shrink-0 rounded-full bg-stone-100 dark:bg-stone-800 border-2 border-stone-200 dark:border-stone-700 z-10 flex items-center justify-center">
                            ...
                            <div className="flex-1 pt-1 opacity-60">
                                <h4 className="text-xl font-bold text-stone-900 dark:text-white">AR Glasses Integration</h4>
                                <p className="text-stone-500 dark:text-stone-400 mt-2 leading-relaxed">Native support for Apple
                        ...
                        <div className="relative flex gap-8">
                            ...
                            <div className="flex-1 pt-1 opacity-60">
                                <h4 className="text-xl font-bold text-stone-900 dark:text-white">Global Marketplace Expansion</h4>
                                <p className="text-stone-500 dark:text-stone-400 mt-2 leading-relaxed">Connecting 3D models directly
            ...
            <footer className="bg-white dark:bg-stone-900 border-t border-stone-200 dark:border-stone-800 pt-20 pb-10 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
                        <div className="flex flex-col gap-6 max-w-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-stone-900 dark:text-white font-bold tracking-tight">Antigravity 3D</h2>
                            </div>
                        ...
                        <div className="flex gap-16 flex-wrap">
                            ...
                            <div className="flex flex-col gap-4">
                                <h4 className="font-bold text-stone-900 dark:text-white">Technology</h4>
                    ...
                    <div className="pt-8 border-t border-stone-100 dark:border-stone-800 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-stone-400 text-xs">© 2024 Antigravity 3D. All rights reserved.</p>
