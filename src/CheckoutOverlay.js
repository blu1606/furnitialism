...
export const CheckoutOverlay = () => {
  const { checkoutStep, setCheckoutStep, cart, clearCart } = useStore()
    ...
    <div className={`checkout-overlay-container ${checkoutStep !== 'none' ? 'active' : ''}`}>
      <div className="checkout-modal glass-panel">
        ...
        <div className="checkout-progress">
          <div className={`step ${['details', 'payment', 'success'].includes(checkoutStep) ? 'active' : ''}`}>Details</div>
        ...
        {checkoutStep === 'success' && (
          <div className="checkout-success">
            ...
            <p>Thank you for choosing LUXE 3D. Your furniture will be delivered with premium care.</p>
