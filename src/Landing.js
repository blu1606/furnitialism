            ...
            <section className="py-24 md:py-32 px-4 md:px-6">
                <div className="max-w-5xl mx-auto flex flex-col gap-16 text-center">
                    <div className="flex flex-col gap-4 items-center">
                        <span
                            className="px-4 py-1.5 rounded-full bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-300 text-xs font-bold uppercase tracking-widest">Augmented
                            Reality</span>
                        <h2 className="text-4xl md:text-6xl font-black text-stone-900 dark:text-white">Find It In <span
                            class="text-glow-primary">Context</span></h2>
                        ...
                        <div className="flex-1 flex flex-col gap-8">
                            <div className="space-y-6">
                                <div className="flex flex-wrap gap-3">
                                    <span
                                        className="px-3 py-1 rounded-full border border-[#d4a373] text-[#d4a373] text-[10px] font-bold uppercase tracking-widest bg-[#d4a373]/5">Hybrid
                                        Animation</span>
                                    <span
                                        className="px-3 py-1 rounded-full border border-[#d4a373] text-[#d4a373] text-[10px] font-bold uppercase tracking-widest bg-[#d4a373]/5">Persistent
                                        State</span>
                                    <span
                                        className="px-3 py-1 rounded-full border border-[#d4a373] text-[#d4a373] text-[10px] font-bold uppercase tracking-widest bg-[#d4a373]/5">Secure
                                        Overlay</span>
                                </div>
                                <h2 className="text-4xl md:text-5xl font-bold text-stone-900 dark:text-white leading-tight">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-stone-900 dark:text-white">From Scan to <span
                            class="text-glow-primary">Sanctuary</span></h2>
                ...
                <div className="flex flex-col md:flex-row gap-16 items-start">
                    ...
                    <div className="flex-1 md:sticky md:top-32">
                        <h2 className="text-3xl md:text-5xl font-bold text-stone-900 dark:text-white mb-6">Product <span
                            class="text-glow-primary">Roadmap</span></h2>
                        ...
                        <div className="relative flex gap-8">
                            ...
                            <div
                                ...
                                <div className="flex justify-between items-center mb-3">
                                    ...
                                    <span
                                        className="text-xs font-bold text-primary bg-primary/10 px-3 py-1 rounded-full uppercase tracking-wider">In
                                        Progress</span>
                                </div>
            ...
            <section className="py-24 md:py-32 bg-stone-900 dark:bg-black relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight leading-tight">Join the <span
                        class="text-glow-primary">Revolution</span></h2>
