        ...
        <div className="bg-background-light dark:bg-background-dark text-stone-900 dark:text-white overflow-x-hidden overflow-y-auto h-full">
                ...
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="size-8 text-primary flex items-center justify-center">
                         ...
                         <h2 className="text-stone-900 dark:text-white text-xl font-bold tracking-tight">{'Smart 3D Interior'}</h2>
                    </div>
                    <nav className="hidden md:flex items-center gap-8">
                         <button className="text-stone-600 hover:text-stone-900 dark:text-stone-300 dark:hover:text-white text-sm font-medium transition-colors" onClick={() => setView('products')}>{'Shop'}</button>
                         <button className="text-stone-600 hover:text-stone-900 dark:text-stone-300 dark:hover:text-white text-sm font-medium transition-colors" onClick={() => setView('home')}>{'Showroom'}</button>
                         <button className="text-stone-600 hover:text-stone-900 dark:text-stone-300 dark:hover:text-white text-sm font-medium transition-colors" onClick={() => setView('products')}>{'Collections'}</button>
                    </nav>
                     <div className="flex items-center gap-4">
                         <button className="hidden sm:block text-stone-900 dark:text-white text-sm font-medium hover:opacity-70 transition-opacity" onClick={() => setView('products')}>{'Sign In'}</button>
                        <button
                ...
                <div className="max-w-7xl w-full mx-auto flex flex-col items-center justify-center gap-12 text-center py-20">
                    <div className="flex flex-col gap-6 max-w-4xl mx-auto z-10">
                        ...
                        <p
                            ...
                            {'Step into the future of furniture shopping with immersive 3D technology and AI-driven interior design simulations.'}
                        </p>
                        ...
                        <div className="flex-1 flex flex-col gap-8 order-2 md:order-1">
                            <div className="space-y-4">
                                ...
                                <p className="text-stone-600 dark:text-stone-400 text-lg leading-relaxed max-w-lg">
                                    {'Experience true-to-life textures and lighting. Our engine renders materials with sub-millimeter accuracy, allowing you to feel the grain of the wood and the weave of the fabric before you buy.'}
                                </p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                         ...
                                         <p className="text-stone-600 dark:text-stone-400 text-sm">{'See how natural light interacts with surfaces at any time of day.'}</p>
                                     </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="p-2 rounded-xl bg-stone-100 dark:bg-stone-800 text-primary">
                                    ...
                                    <div>
                                         ...
                                         <p className="text-stone-600 dark:text-stone-400 text-sm">{'Zoom in up to 400% without losing visual fidelity.'}</p>
                                     </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
                        ...
                        <div className="flex-1 flex flex-col gap-8">
                            <div className="space-y-4">
                                ...
                                <p className="text-stone-600 dark:text-stone-400 text-lg leading-relaxed max-w-lg">
                                    {'Our proprietary AI Forge technology converts simple 2D images into fully realized 3D models instantly. Upload a sketch or a photo, and watch it come to life in our virtual showroom.'}
                                </p>
                            </div>
            ...
            <section className="py-24 md:py-32 px-4 md:px-6">
                <div className="max-w-5xl mx-auto flex flex-col gap-16 text-center">
                    <div className="flex flex-col gap-4 items-center">
                         <span
                             className="px-4 py-1.5 rounded-full bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-300 text-xs font-bold uppercase tracking-widest">{'Augmented Reality'}</span>
                         <h2 className="text-4xl md:text-6xl font-black text-stone-900 dark:text-white">{'Find It In'} <span
                             className="text-glow-primary">{'Context'}</span></h2>
                         <p className="text-lg text-stone-600 dark:text-stone-400 max-w-xl mx-auto">
                             {'Unsure if it fits? Use our AI Contextual Search to project furniture directly into your living space through your camera.'}
                         </p>
                    </div>
                        ...
                        <div className="flex-1 flex flex-col gap-8">
                            <div className="space-y-6">
                                <div className="flex flex-wrap gap-3">
                                    <span
                                        className="px-3 py-1 rounded-full border border-[#d4a373] text-[#d4a373] text-[10px] font-bold uppercase tracking-widest bg-[#d4a373]/5">{'Hybrid Animation'}</span>
                                    <span
                                        className="px-3 py-1 rounded-full border border-[#d4a373] text-[#d4a373] text-[10px] font-bold uppercase tracking-widest bg-[#d4a373]/5">{'Persistent State'}</span>
                                    <span
                                        className="px-3 py-1 rounded-full border border-[#d4a373] text-[#d4a373] text-[10px] font-bold uppercase tracking-widest bg-[#d4a373]/5">{'Secure Overlay'}</span>
                                </div>
                                <h2 className="text-4xl md:text-5xl font-bold text-stone-900 dark:text-white leading-tight">
                                    {'Seamless'} <span className="text-glow-primary">{'Conversion'}</span>
                                </h2>
                                <p className="text-stone-600 dark:text-stone-400 text-lg leading-relaxed max-w-lg">
                                    {'Experience our "Hybrid Context Model". Watch as 3D objects transform into 2D UI elements via the signature "CartOrb" animation. Includes persistent state and a secure, multi-step checkout overlay.'}
                                </p>
                            </div>
            ...
            <section className="py-24 md:py-32 bg-white dark:bg-stone-900 border-y border-stone-100 dark:border-stone-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                         <h2 className="text-3xl md:text-5xl font-bold text-stone-900 dark:text-white">{'From Scan to'} <span
                             className="text-glow-primary">{'Sanctuary'}</span></h2>
                         <p className="text-stone-600 dark:text-stone-400 mt-4 max-w-2xl mx-auto">{'A streamlined process designed for efficiency and elegance.'}</p>
                     </div>
                    <div className="relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                            ...
                            <div className="flex flex-col items-center text-center group">
                                 ...
                                 <p className="text-sm text-stone-600 dark:text-stone-400 px-4">{'Use your phone to capture a 360° scan of your space.'}</p>
                             </div>
                            {/* Step 2 */}
                            <div className="flex flex-col items-center text-center group">
                                 <div
                                 ...
                                 <p className="text-sm text-stone-600 dark:text-stone-400 px-4">{'Our engine identifies dimensions, lighting, and style.'}</p>
                             </div>
                            {/* Step 3 */}
                            <div className="flex flex-col items-center text-center group">
                                 <div
                                 ...
                                 <p className="text-sm text-stone-600 dark:text-stone-400 px-4">{'Generate and tweak your new interior in real-time.'}</p>
                             </div>
                            {/* Step 4 */}
                            <div className="flex flex-col items-center text-center group">
                                 <div
                                 ...
                                 <p className="text-sm text-stone-600 dark:text-stone-400 px-4">{'Buy all generated furniture items directly.'}</p>
                             </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row gap-16 items-start">
                    ...
                    <div className="flex-1 md:sticky md:top-32">
                        <h2 className="text-3xl md:text-5xl font-bold text-stone-900 dark:text-white mb-6">{'Product'} <span
                             className="text-glow-primary">{'Roadmap'}</span></h2>
                         <p className="text-stone-600 dark:text-stone-400 mb-8 text-lg">{'We are building the future of commerce. See where we are headed.'}</p>
                        <div
                        ...
                        <div className="relative flex gap-8">
                            <div
                             ...
                             <div className="flex-1 pt-1">
                                 <h4 className="text-xl font-bold text-stone-900 dark:text-white line-through opacity-50">{'Foundation & AI Core'}</h4>
                                 <p className="text-stone-500 dark:text-stone-500 mt-2">{'Initial release of the 3D rendering engine and basic furniture database.'}</p>
                             </div>
                        </div>
                        {/* Item 2: Active */}
                        <div className="relative flex gap-8">
                            ...
                            <div
                                className="flex-1 pt-1 glass-card p-6 rounded-2xl border-l-4 border-l-primary hover-pulse transition-all">
                                 <div className="flex justify-between items-center mb-3">
                                     <h4 className="text-xl font-bold text-stone-900 dark:text-white">{'Smart Recommendation Engine'}
                                     </h4>
                                     <span
                                         className="text-xs font-bold text-primary bg-primary/10 px-3 py-1 rounded-full uppercase tracking-wider">{'In Progress'}</span>
                                 </div>
                                 <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{'Training models on 50k+ designer portfolios to suggest personalized layouts based on space and lighting.'}</p>
                            </div>
                        </div>
                        {/* Item 3: Future */}
                        <div className="relative flex gap-8">
                            <div
                             ...
                             <div className="flex-1 pt-1 opacity-60">
                                 ...
                                 <p className="text-stone-500 dark:text-stone-400 mt-2 leading-relaxed">{'Native support for Apple Vision Pro and Meta Quest 3 for mixed-reality spatial designs.'}</p>
                             </div>
                        </div>
                        {/* Item 4: Future */}
                        <div className="relative flex gap-8">
                            <div
                             ...
                             <div className="flex-1 pt-1 opacity-60">
                                 ...
                                 <p className="text-stone-500 dark:text-stone-400 mt-2 leading-relaxed">{'Connecting 3D models directly with logistics from over 500+ international artisan furniture brands.'}</p>
                             </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 md:py-32 bg-stone-900 dark:bg-black relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight leading-tight">{'Join the'} <span
                         className="text-glow-primary">{'Revolution'}</span></h2>
                     <p className="text-xl text-stone-400 mb-12 max-w-2xl mx-auto leading-relaxed">{'Ready to transform your space with the most advanced interior design AI ever built? Early access slots are limited.'}</p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
                     ...
                     <p className="text-stone-600 text-sm mt-8 uppercase tracking-widest font-bold">{'Limited slots available for Q1 2024'}</p>
                </div>
            </section>
            ...
            <footer className="bg-white dark:bg-stone-900 border-t border-stone-200 dark:border-stone-800 pt-20 pb-10 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
                        <div className="flex flex-col gap-6 max-w-sm">
                            <div className="flex items-center gap-2">
                                 ...
                                 <h2 className="text-stone-900 dark:text-white font-bold tracking-tight">{'Smart 3D Interior'}</h2>
                             </div>
                             <p className="text-stone-500 text-sm leading-relaxed">
                                 {'Redefining luxury interiors with spatial computing and artificial intelligence. Experience the impossible from the comfort of your home.'}
                             </p>
                        </div>
                        <div className="flex gap-16 flex-wrap">
                             <div className="flex flex-col gap-4">
                                 <h4 className="font-bold text-stone-900 dark:text-white">{'Product'}</h4>
                                 <a className="text-stone-500 hover:text-primary text-sm" href="#">{'Shop'}</a>
                    ...
                    <div
                        ...
                        <p className="text-stone-400 text-xs">{'© 2024 Smart 3D Interior. All rights reserved.'}</p>
